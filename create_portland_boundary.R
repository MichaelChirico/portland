...
portland.bdy.simp <- as(portland.bdy.simp, "SpatialPolygonsDataFrame") # need to save using rgdal
writeOGR(obj=portland.bdy.simp, dsn="data", layer="portland_boundary", driver="ESRI Shapefile")
